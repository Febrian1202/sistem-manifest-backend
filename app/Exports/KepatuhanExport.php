...
class KepatuhanExport implements FromCollection, ShouldAutoSize, WithHeadings, WithMapping, WithStyles, WithTitle
{
    protected $reports;
    ...
    public function __construct($reports, $startDate, $endDate, $approvalData = null)
    {
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        foreach ($this->reports as $index => $report) {
            ...
            if ($report->status === 'Berlisensi') {
                ...
                $sheet->getStyle($cell)->getFill()->setFillType(Fill::FILL_SOLID)->getStartColor()->setRGB('FEF9C3');
