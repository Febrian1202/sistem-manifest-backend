                    ...
                    <x-ui.table.table-row>
                        ...
                        <x-ui.table.table-cell class="text-right">
                            ...
                            <div class="flex items-center justify-end gap-2">
                                ...
                                {{-- B. DETAIL LINK (Ke Halaman Show) --}}
                                <a href="{{ route('computers.show', $computer) }}">
                                    <x-ui.button type="button" variant="ghost" size="sm" class="h-8 w-8 p-0 text-blue-600 hover:text-blue-700 hover:bg-blue-100" title="Lihat Detail">
